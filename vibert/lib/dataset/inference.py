...
class HoloInference(Dataset):
    def __init__(self, root_dir, frame_paths, bboxes, crop_size=224, scale=1.0):
    ...
    def __getitem__(self, idx):
        ...
        norm_img, _, _ = get_single_image_crop_demo(img, bbox, kp_2d=None, scale=self.scale, crop_size=self.crop_size)
